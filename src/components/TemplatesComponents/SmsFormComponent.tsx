...
function SmsFormComponent({
    ...
    return (
        <Wrapper>
            <ToggleBlock>
                <LabelBlock><MessageIcon/> {t("templates.action.edit.labels.sms") as string}</LabelBlock>
                <Toggle isActive={isSms} onToggle={() => onChange('isEmail', !isSms)}/>
            </ToggleBlock>
